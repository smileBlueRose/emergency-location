export const translations = {
  ru: {
    ...
    photo: {
      ...
      supportedFormats: 'Поддерживаются JPG, PNG, WEBP, HEIC',
    ...
    request: {
      ...
      error: 'Произошла ошибка во время отправки запроса.',
      number: 'Заявка',
  ...
  kk: {
    ...
    photo: {
      ...
      invalidFile: 'Файл сурет форматында емес',
      supportedFormats: 'Қолдау көрсетіледі: JPG, PNG, WEBP, HEIC',
      tooMany: 'Сіз 20-дан артық фото тіркей алмайсыз',
      remove: 'Фотоны жою',
    },
  ...
  en: {
    ...
    photo: {
      ...
      invalidFile: 'The file is not an image',
      supportedFormats: 'Supported formats: JPG, PNG, WEBP, HEIC',
      tooMany: 'You can attach no more than 20 photos',
      remove: 'Remove photo',
    },
